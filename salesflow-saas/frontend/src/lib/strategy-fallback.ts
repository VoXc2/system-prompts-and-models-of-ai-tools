  ...
  planes: [
    {
      ...
      capabilities: ["signal detection", "triage", "scenario analysis", "memo generation", "forecasting", "next best action"],
    ...
    },
    {
      ...
      capabilities: ["durable workflows", "approval / resume later", "timeout handling", "compensation", "idempotent side effects", "cross-system orchestration"],
    ...
    },
    {
      ...
      capabilities: ["policy engine", "approval routing", "fine-grained authorization", "secrets governance", "tool verification ledger", "contradiction detection"],
    ...
    },
    {
      ...
      capabilities: ["operational source of truth", "semantic memory", "document extraction", "data quality", "event contracts", "telemetry"],
      building_blocks: ["PostgreSQL", "pgvector", "Airbyte", "Unstructured", "Great Expectations", "CloudEvents + AsyncAPI", "OpenTelemetry"],
    ...
    },
    {
      ...
      capabilities: ["rulesets", "protected branches", "deployment protection", "OIDC federation", "artifact attestations", "external audit streaming"],
